...
public class SysEncodingSetRuleServiceImpl extends ServiceImpl<SysEncodingSetRuleDao, SysEncodingSetRule> implements ISysEncodingSetRuleService {
    ...
    public List<SysEncodingSetRuleVO> list(SysEncodingSetRuleQuery query) {
        ...
        String ruleIn = SUtil.format(CacheConstant.SysSetRule.CODE_RULE, query.getSysEncodingCode(), query.getSysEncodingSetCode());
        // 存放Redis
    ...
    private void updateAndCache(SysEncodingSetRule entity, SysEncodingSet sysEncodingSet) {
        ...
        // 存放Redis
        String ruleIn = SUtil.format(CacheConstant.SysSetRule.CODE_RULE, entity.getSysEncodingCode(), entity.getSysEncodingSetCode());
     ...
     **/
    private SysEncodingSet checkToUse(SysEncodingSetRule sysEncodingSetRule) {
        // 查询编码集是否已经使用
