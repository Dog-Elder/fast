package com.fast.core.safe.util;
 ...
 */
@Component
public class ManageUtil implements AccountManage {
    /**
     * 账号类型标识
     */
    ...
    public boolean supports(String token) {
        ...
        return TYPE.equals(logicalType.toString());
    }
     ...
     */
    @Override
    public Object getLoginId(String tokenValue) {
        return getLoginIdByToken(tokenValue);
    }

    /**
     * 获得登录帐户类型
     *
     * @return {@link ManageUtil#TYPE}
     */
    @Override
